...
if __name__ == '__main__':
	...
	original = cv2.imread(r"C:\6th Semester\DIP\LAB DIP\Codes\Tanishk.png")
	...
	cv2.createTrackbar('Contrast', 'TANISHK',
					127, 2 * 127,
					BrightnessContrast)
